...
const OPERATING_LENSES = [
  {
    icon: Radar,
    title: "Expansion",
    body: "See where competitors are adding regions, managers, and new teams."
  },
  {
    icon: Sparkles,
    title: "AI demand",
    body: "Separate generic hiring from deliberate AI and data investment."
  },
  {
    icon: BarChart3,
    title: "Weekly readout",
    body: "Turn raw openings into a fast operator brief."
  }
];

const WORKFLOW = [
  { step: "01", title: "Collect", body: "Pull public Greenhouse and Lever postings across the cohort." },
    ...
    <div className="pb-24">
      <section className="shell relative overflow-hidden pt-16 md:pt-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-lg text-base leading-7 text-muted-strong md:text-lg">
            Track hiring momentum, AI share, and expansion moves across leading software companies.
          </p>
      ...
      <section className="shell mt-24">
        <SectionHeading
          ...
          title="Hiring is an early signal of company intent."
          description="TalentFlux turns openings into a clear read on AI investment, org buildout, and expansion."
          size="lg"
        />
      ...
      <section className="shell mt-24 grid gap-6 lg:grid-cols-[1fr_1.2fr]">
        ...
        <div className="space-y-6">
          <SectionHeading
            eyebrow="Live alerts"
            title="Grounded signals, not filler."
            description="Every alert ties back to computed metrics and explainable thresholds."
            size="lg"
          />
      ...
      <section className="shell mt-24">
        <SectionHeading
          eyebrow="Cohort"
          title="Coverage across the software stack."
          description="Tracked companies span infra, collaboration, CRM, cloud, and data platforms."
          size="lg"
        />
      ...
      <section className="shell mt-24">
        <SectionHeading
          ...
          description="Every output traces back to collected data and explainable scoring rules."
          size="lg"
        />
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {WORKFLOW.map((item) => (
          ...
          <div className="relative flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
            <div className="max-w-xl space-y-3">
              ...
              <p className="text-sm leading-6 text-muted-strong md:text-base">
                Open the live signal desk to review momentum, AI-share, and expansion alerts across the cohort.
              </p>
            </div>
